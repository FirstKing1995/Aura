...
(function (root) {
  ...
  const DICTIONARIES = {
    ...
    /* ====================== Português ====================== */
    pt: {
      'home.lobby': 'Jogadores online',
      'lobby.title': 'Jogadores online',
      'lobby.subtitle': 'Escolha alguém e mande um desafio. A partida começa quando a pessoa aceitar.',
      'lobby.connecting': 'Entrando no lobby',
      'lobby.online': '{count} online agora',
      'lobby.empty': 'Ninguém online. Deixe esta tela aberta: você aparece para os outros enquanto ela estiver aqui.',
      'lobby.challenge': 'Desafiar',
      'lobby.waiting': 'Aguardando',
      'lobby.inMatch': 'Em partida',
      'lobby.sent': 'Desafio enviado',
      'lobby.sentTo': 'Desafio enviado para {name}',
      'lobby.cancelChallenge': 'Cancelar',
      'lobby.challengedYou': '{name} ({elo} Elo) desafiou você',
      'lobby.accept': 'Aceitar',
      'lobby.decline': 'Recusar',
      'lobby.needAccount': 'O lobby precisa de conta. Jogando contra a IA.',
      'error.SELF_CHALLENGE': 'Você não pode desafiar a si mesmo.',
      'error.PLAYER_GONE': 'Esse jogador não está mais aqui.',
      'error.PLAYER_OFFLINE': 'Esse jogador saiu do lobby.',
      'error.PLAYER_BUSY': 'Esse jogador já está em partida.',
      'error.ALREADY_IN_MATCH': 'Você já está em uma partida.',
      'error.CHALLENGE_GONE': 'Esse desafio não existe mais.',
      'error.CHALLENGE_EXPIRED': 'O desafio expirou.',
      'error.NOT_YOUR_CHALLENGE': 'Esse desafio não é seu.',
    ...
    /* ====================== English ====================== */
    en: {
      'home.lobby': 'Players online',
      'lobby.title': 'Players online',
      'lobby.subtitle': 'Pick someone and send a challenge. The match starts when they accept.',
      'lobby.connecting': 'Joining the lobby',
      'lobby.online': '{count} online right now',
      'lobby.empty': 'Nobody online. Keep this screen open: others can see you while it is.',
      'lobby.challenge': 'Challenge',
      'lobby.waiting': 'Waiting',
      'lobby.inMatch': 'In a match',
      'lobby.sent': 'Challenge sent',
      'lobby.sentTo': 'Challenge sent to {name}',
      'lobby.cancelChallenge': 'Cancel',
      'lobby.challengedYou': '{name} ({elo} Elo) challenged you',
      'lobby.accept': 'Accept',
      'lobby.decline': 'Decline',
      'lobby.needAccount': 'The lobby needs an account. Playing the AI.',
      'error.SELF_CHALLENGE': 'You cannot challenge yourself.',
      'error.PLAYER_GONE': 'That player is no longer here.',
      'error.PLAYER_OFFLINE': 'That player left the lobby.',
      'error.PLAYER_BUSY': 'That player is already in a match.',
      'error.ALREADY_IN_MATCH': 'You are already in a match.',
      'error.CHALLENGE_GONE': 'That challenge no longer exists.',
      'error.CHALLENGE_EXPIRED': 'The challenge expired.',
      'error.NOT_YOUR_CHALLENGE': 'That challenge is not yours.',
    ...
    /* ====================== Español ====================== */
    es: {
      'home.lobby': 'Jugadores en línea',
      'lobby.title': 'Jugadores en línea',
      'lobby.subtitle': 'Elige a alguien y envía un desafío. La partida empieza cuando acepte.',
      'lobby.connecting': 'Entrando al lobby',
      'lobby.online': '{count} en línea ahora',
      'lobby.empty': 'Nadie en línea. Deja esta pantalla abierta: los demás te ven mientras esté aquí.',
      'lobby.challenge': 'Desafiar',
      'lobby.waiting': 'Esperando',
      'lobby.inMatch': 'En partida',
      'lobby.sent': 'Desafío enviado',
      'lobby.sentTo': 'Desafío enviado a {name}',
      'lobby.cancelChallenge': 'Cancelar',
      'lobby.challengedYou': '{name} ({elo} Elo) te desafió',
      'lobby.accept': 'Aceptar',
      'lobby.decline': 'Rechazar',
      'lobby.needAccount': 'El lobby necesita cuenta. Jugando contra la IA.',
      'error.SELF_CHALLENGE': 'No puedes desafiarte a ti mismo.',
      'error.PLAYER_GONE': 'Ese jugador ya no está aquí.',
      'error.PLAYER_OFFLINE': 'Ese jugador salió del lobby.',
      'error.PLAYER_BUSY': 'Ese jugador ya está en partida.',
      'error.ALREADY_IN_MATCH': 'Ya estás en una partida.',
      'error.CHALLENGE_GONE': 'Ese desafío ya no existe.',
      'error.CHALLENGE_EXPIRED': 'El desafío expiró.',
      'error.NOT_YOUR_CHALLENGE': 'Ese desafío no es tuyo.',
